...
public class CapitalTest01 {
	...
	public static void main(String[] args) {
		...
		List<String> valueList = new ArrayList<>(values); // 나라이름 List의 index로 문제 낼 것
		int score = 0;
		for (int i = 0; i < 5; i++) {
			int randCountry = rand.nextInt(20);
			System.out.print(keyList.get(randCountry) + "의 수도 이름은? : ");
			String capital = scan.next();
			
        	if (valueList.get(randCountry).equals(capital)) {
